...
<div id="comments">
	...
	'comment_notes_after' => '',
	'comment_field' => '<label style="clear:both; margin-top: 8px;">' . __('Comment', 'ipin') . '</label> <textarea class="form-control" id="comment" name="comment" rows="10" aria-required="true"></textarea>'
	));
	?>
</div>